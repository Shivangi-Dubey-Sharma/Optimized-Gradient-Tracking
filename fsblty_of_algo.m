function [Pf,rho,lmbda1, Cvx_s,t] = fsblty_of_algo(n,d,Mfnl,M_1,M_2,M_3,M_4,M_5,F,G)
...
% M_1 to M_5 are matrices defining special case of GGT \in R^(n X n) (will be converted to nd X nd in the function itself)
...
rol = 0.1;  %ideally it sholuld be 0 but for getting result fast I have started with it
rou = 1;
num_run = 0;
